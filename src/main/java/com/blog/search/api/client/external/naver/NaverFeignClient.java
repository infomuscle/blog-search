...
public interface NaverFeignClient extends ExternalFeignClient {
    ...
    NaverClientResponse search(@RequestParam(value = "query") String query, @RequestParam(value = "sort", required = false) String sort, @RequestParam(value = "start", required = false) Integer start, @RequestParam(value = "display", required = false) Integer display);
